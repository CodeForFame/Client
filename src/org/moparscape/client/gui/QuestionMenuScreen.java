package org.moparscape.client.gui;
...
import org.moparscape.client.interfaces.models.Callback;
import org.moparscape.client.interfaces.models.HoverCallback;
import org.moparscape.client.interfaces.models.ILabel;
import org.moparscape.client.interfaces.models.IPanel;
import org.moparscape.client.interfaces.models.ISprite;
import org.moparscape.client.interfaces.models.OnMisClickCallBack;
import org.moparscape.client.interfaces.models.RSGuiModels;
import org.moparscape.client.util.Util;

public class QuestionMenuScreen {
	...
	public static InterfaceGUI createScreen(final mudclient mc) {
		...
		Callback questioncallback = new Callback(){
			@Override
			public void run(InterfaceGUI gui, RSGuiModels id) {
		...
		for(int bla = 0; bla < 6; bla++) {
			qy = ferlewp * 5;
			final ILabel its = i.addLabel("", 100, 20+qy, questioncallback,1);
			ferlewp++;
		}
		/*
		int[] items = Util.IRON;
